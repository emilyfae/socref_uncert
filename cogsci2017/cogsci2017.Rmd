---
title: "Children's social referencing as active information gathering"
...
```{r image, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=2, fig.height=2, set.cap.width=T, num.cols.cap=1, fig.cap = "Study design for Experiment 1."}
