...
As evident from Figure \ref{fig:results_e2}, there were significant differences in the number of looks across phases, such that the planning and response phases had significantly more and the slide phase had significantly fewer looks than the label phase. In addition, there was an interaction of phase with familiarity such that the response phase of novel trials was associated with significantly more looks. There was a three-way interaction of familiarity, gaze, and phase, such that the response phase of mutual exclusivity trials in the no-gaze condition was associated with more looks. Finally, we observed a four-way interaction such that the response phase of novel trials in the gaze condition was associated with more looking with increasing age.
