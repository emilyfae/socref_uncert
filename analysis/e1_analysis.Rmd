...
```{r}
t <- msslooks 
t$age <- str_replace(t$age_years, "2", "two")
t$age <- str_replace(t$age, "3", "three")
t$age <- str_replace(t$age, "4", "four")
t$age <- str_replace(t$age, "5", "five")
t <- t %>%
  spread(familiarity, num_looks)
```

Labeling phase
```{r}
#Novel vs. Familiar, 2-year-olds
t.test(subset(t$novel, t$phase_name == "label_request" & t$age == "two" & t$num_objs == 2),subset(t$familiar, t$phase_name == "label_request" & t$age == "two" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 3-year-olds
t.test(subset(t$novel, t$phase_name == "label_request" & t$age == "three" & t$num_objs == 2),subset(t$familiar, t$phase_name == "label_request" & t$age == "three" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 4-year-olds
t.test(subset(t$novel, t$phase_name == "label_request" & t$age == "four" & t$num_objs == 2),subset(t$familiar, t$phase_name == "label_request" & t$age == "four" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 5-year-olds
t.test(subset(t$novel, t$phase_name == "label_request" & t$age == "five" & t$num_objs == 2),subset(t$familiar, t$phase_name == "label_request" & t$age == "five" & t$num_objs == 2), paired = TRUE)
```

Slide phase
```{r}
#Novel vs. Familiar, 2-year-olds
t.test(subset(t$novel, t$phase_name == "request_slide" & t$age == "two" & t$num_objs == 2),subset(t$familiar, t$phase_name == "request_slide" & t$age == "two" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 3-year-olds
t.test(subset(t$novel, t$phase_name == "request_slide" & t$age == "three" & t$num_objs == 2),subset(t$familiar, t$phase_name == "request_slide" & t$age == "three" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 4-year-olds
t.test(subset(t$novel, t$phase_name == "request_slide" & t$age == "four" & t$num_objs == 2),subset(t$familiar, t$phase_name == "request_slide" & t$age == "four" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 5-year-olds
t.test(subset(t$novel, t$phase_name == "request_slide" & t$age == "five" & t$num_objs == 2),subset(t$familiar, t$phase_name == "request_slide" & t$age == "five" & t$num_objs == 2), paired = TRUE)
```

Planning phase
```{r}
#Novel vs. Familiar, 2-year-olds
t.test(subset(t$novel, t$phase_name == "slide_touch" & t$age == "two" & t$num_objs == 2),subset(t$familiar, t$phase_name == "slide_touch" & t$age == "two" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 3-year-olds
t.test(subset(t$novel, t$phase_name == "slide_touch" & t$age == "three" & t$num_objs == 2),subset(t$familiar, t$phase_name == "slide_touch" & t$age == "three" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 4-year-olds**
t.test(subset(t$novel, t$phase_name == "slide_touch" & t$age == "four" & t$num_objs == 2),subset(t$familiar, t$phase_name == "slide_touch" & t$age == "four" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 5-year-olds ^
t.test(subset(t$novel, t$phase_name == "slide_touch" & t$age == "five" & t$num_objs == 2),subset(t$familiar, t$phase_name == "slide_touch" & t$age == "five" & t$num_objs == 2), paired = TRUE)
```

Response phase
```{r}
#Novel vs. Familiar, 2-year-olds *
t.test(subset(t$novel, t$phase_name == "touch_response" & t$age == "two" & t$num_objs == 2),subset(t$familiar, t$phase_name == "touch_response" & t$age == "two" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 3-year-olds **
t.test(subset(t$novel, t$phase_name == "touch_response" & t$age == "three" & t$num_objs == 2),subset(t$familiar, t$phase_name == "touch_response" & t$age == "three" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 4-year-olds **
t.test(subset(t$novel, t$phase_name == "touch_response" & t$age == "four" & t$num_objs == 2),subset(t$familiar, t$phase_name == "touch_response" & t$age == "four" & t$num_objs == 2), paired = TRUE)

#Novel vs. Familiar, 5-year-olds **
t.test(subset(t$novel, t$phase_name == "touch_response" & t$age == "five" & t$num_objs == 2),subset(t$familiar, t$phase_name == "touch_response" & t$age == "five" & t$num_objs == 2), paired = TRUE)
```
...
maximal_mod <- lmer(num_looks ~ num_objs * familiarity *  
                      age_c * phase_name +
...
lr_lm <- lmer(num_looks ~ num_objs * familiarity * age_c +
             (num_objs * familiarity | SID),
           data = filter(lmer_data, phase_name == "label_request"))

summary(lr_lm)

rs_lm <- lmer(num_looks ~ num_objs * familiarity * age_c +
             (num_objs | SID),
           data = filter(lmer_data, phase_name == "request_slide"))

summary(rs_lm)

st_lm <- lmer(num_looks ~ num_objs * familiarity * age_c +
             (num_objs + familiarity | SID),
           data = filter(lmer_data, phase_name == "slide_touch"))

summary(st_lm)

tr_lm <- lmer(num_looks ~ num_objs * familiarity * age_c +
             (num_objs  | SID),
           data = filter(lmer_data, phase_name == "touch_response"))
