...
acc_g$trial <- as.character(acc_g$trial)
acc$trial <- as.character(acc$trial)

acc_g$SID <- as.character(acc_g$SID)
acc$SID <- as.character(acc$SID)
...
length(unique(d$trial))


d$acc[d$trial_type == "novel"] <- d$acc_gaze[d$trial_type == "novel"]
