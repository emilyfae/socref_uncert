...
for (f in files) {
  ...
  id <- data.frame(SID = f,
                   ...
                   num_ques = jd$reference.num_ques,
                   num_sou = as.numeric(jd$reference.num_SOU),
...
Plot questions by trial type (familiar, novel, mutual exclusivity) and presence of referential gaze.
