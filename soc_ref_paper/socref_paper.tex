...
attention (D. Baldwin, 1993; Tomasello \& Farrar, 1986).\footnote{We use
...
predictions, even when they are calibrated overall to accuracy (C.
Coughlin et al., 2014; Hembacher \& Ghetti, 2014, Schneider (1998)). If
children are not aware of the need for disambiguating information, they
may not selectively reference social information on ambiguous trials.
...
Vaish et al. (2011) for use with young children. In contrast to Vaish et
al., we control for the number of objects in Experiment 1 by including
trials with two novel objects (referentially ambiguous), two familiar
objects (referentially unambiguous), one novel object (referentially
...
**add something here about how additional evidence for a hypothesis
should lead to more information seeking in the aggregate, althought not
necessarily at the individual level (e.g., daw, pigeon paper). The idea
that children are sensitive to graded evidence is critical for
probabalistic models of learning, so if we find evidence for this, it
...
and Acting on It During the Preschool Years: A Metacognitive Approach.
