...
\hypersetup{breaklinks=true,
            pdfauthor={},
            pdftitle={Children's social referencing reflects sensitivity to uncertainty},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=black,
...
ambiguous. In Experiment 2, 3- to 4-year-old children also referenced
more when there was a novel referent and familiar distractor (and the
referent could thus be inferred), but only when referential gaze was
unavailable. These results suggest that children are able to seek
disambiguating social information on the basis of graded uncertainty.}
...
attention (Baldwin, 1993; Tomasello \& Farrar, 1986)\footnote{We use the
  term \enquote{social referencing} to indicate the generic behavior of
...
\texttt{number\ of\ looks\ \textasciitilde{}\ number\ of\ objects\ *\ familiarity\ *\ age\ in\ months\ +\ (number\ of\ objects\ +\ familiarity\ \textbar{}\ subject)}\footnote{All
  regression tables can be found in Online Supplementary Materials.}.
...
In Y. S. J Platt D Koller (Ed.), \emph{Advances in neural information
processing systems} (Vol. 20, pp. 369--376). Red Hook, NY: Curran.
