...
During the preschool years, children are increasingly able to actively gather information through help-seeking and exploration [@Chouinard2007; @Schulz2007]. They are also increasingly proficient at explicitly identifying their gaps in knowledge and their uncertainty in various domains [@Hembacher2014; @Coughlin2014; @Lyons2011a; @Rohwer2012]. Do young children similarly identify lexical ambiguity and engage in appropriate active learning behaviors in response? Here, we examined whether young children's social information gathering was associated with uncertainty about the referent of a label produced by an adult, in situations in which the referent was either known or completely novel (Experiment 1), and when there were differing amounts of referential evidence (Experiment 2). 
