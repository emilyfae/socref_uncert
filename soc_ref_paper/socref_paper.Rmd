...
```{r acc_e2, fig.env='figure*',fig.width=6, fig.height=3, fig.align='center', fig.pos='b', fig.cap='Accuracy for trials with a correct answer (FF and FN, and all gaze trials) in Experiment 2. Error bars are 95 percent confidence intervals.'}
