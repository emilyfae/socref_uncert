...
**add something here about how additional evidence for a hypothesis should lead to more information seeking in the aggregate, althought not necessarily at the individual level (e.g., daw, pigeon paper). The idea that children are sensitive to graded evidence is critical for probabalistic models of learning, so if we find evidence for this, it would support that theory.
