...
e1_l.tab <- e1_l.tab[,c(6,1:5)]
names(e1_l.tab)[5:6] <- c("$t$ value","$p$ value")
...
e1_s.tab <- e1_s.tab[,c(6,1:5)]
names(e1_s.tab)[5:6] <- c("$t$ value","$p$ value")
...
e1_p.tab <- e1_p.tab[,c(6,1:5)]
names(e1_p.tab)[5:6] <- c("$t$ value","$p$ value")
...
e1_r.tab <- e1_r.tab[,c(6,1:5)]
names(e1_r.tab)[5:6] <- c("$t$ value","$p$ value")
...
Overall, these results provide evidence that preschool-aged children monitor graded uncertainty in their mental representations and act on that uncertainty through spontaneous information-seeking. 
