...
```{r}
e1.tab <- as.data.frame(label_lm$coef)

e1.tab$Predictor <- c("Intercept",
                      "Number of Objects(2)",
                      "Familiarity(novel)",
                      "Age",
                      "Number of Objects(2)*Familiarity(novel)",
                      "Number of Objects(2)*Age",
                      "Familiarity(novel)*Age",
                      "Number of Objects(2)*Familiarity(novel)*Age")
