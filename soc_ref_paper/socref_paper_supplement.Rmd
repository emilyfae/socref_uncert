---
title             : "Online Supplemental Materials for: Children's social referencing reflects sensitivity to uncertainty"
...
# apa_table(e1_r.tab,
#           longtable = TRUE, 
#           caption = "Predictor estimates with standard errors and significance information for a linear mixed-effects model predicting social referencing in the response phase in Experiment 1. Parentheticals indicate the reference level for dummy-coded variables.")
...
# apa_table(e2acc.tab,
#           longtable = TRUE, 
#           caption = "Predictor estimates with standard errors and significance information for a linear mixed-effects model predicting social referencing based on accuracy in Experiment 2. Parentheticals indicate the reference level for dummy-coded variables.")
